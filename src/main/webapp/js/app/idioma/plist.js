...
moduleIdioma.controller('idiomaPlistController', ['$scope', '$http', '$location', 'toolService', '$routeParams', 'sessionService',
    function ($scope, $http, $location, toolService, $routeParams, sessionService) {
        ...
        $http({
            ...
            $scope.ajaxDataIdiomaNumber = response.data.message;
            $scope.totalPages = Math.ceil($scope.ajaxDataIdiomaNumber / $scope.rpp);
            ...
            $scope.ajaxDataIdiomaNumber = response.data.message || 'Request failed';
            $scope.status = response.status;
        });
